...
__export(FilterAlteredClicks_exports, {
  filterAlteredClicks: function filterAlteredClicks() {
    return _filterAlteredClicks;
  }
});
module.exports = __toCommonJS(FilterAlteredClicks_exports);
function _filterAlteredClicks(callback, onlyPhysical) {
